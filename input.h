...
#define BUTTON_ANALOG_L_RIGHTUP				0x00000800l	// 左アナログスティック右上　	(.IX>0)			&&	(.IY>0)
#define BUTTON_ANALOG_L_RIGHT				0x00001000l	// 左アナログスティック右		(.IX>0)
#define BUTTON_ANALOG_L_RIGHTDOWN			0x00002000l	// 左アナログスティック右下	　　(.IX>0)			&&	(.IY<0)
#define BUTTON_ANALOG_L_DOWN				0x00004000l	// 左アナログスティック下							(.IY<0)
#define BUTTON_ANALOG_L_LEFTDOWN			0x00008000l	// 左アナログスティック左下	　　(.IX<0)			&&	(.IY<0)
#define BUTTON_ANALOG_L_LEFT				0x00010000l	// 左アナログスティック左		(.IX<0)
#define BUTTON_ANALOG_L_LEFTUP				0x00020000l	// 左アナログスティック左上	　　(.IX<0)			&&	(.IRY>0)
//#define BUTTON_ANALOG_R_UP					0x00000400l	// 右アナログスティック上							(.IRY>0)
//#define BUTTON_ANALOG_R_RIGHTUP				0x00000800l	// 右アナログスティック右上	　　(.IRX>0)		&&	(.IRY>0)
//#define BUTTON_ANALOG_R_RIGHT				0x00001000l	// 右アナログスティック右		(.IRX>0)
//#define BUTTON_ANALOG_R_RIGHTDOWN			0x00002000l	// 右アナログスティック右下　　	(.IRX>0)		&&	(.IRY<0)
//#define BUTTON_ANALOG_R_DOWN				0x00004000l	// 右アナログスティック下							(.IRY<0)
//#define BUTTON_ANALOG_R_LEFTDOWN			0x00008000l	// 右アナログスティック左下		(.IRX<0)		&&	(.IRY<0)
//#define BUTTON_ANALOG_R_LEFT				0x00010000l	// 右アナログスティック左		(.IX<0)
//#define BUTTON_ANALOG_R_LEFTUP				0x00020000l	// 右アナログスティック左上		(.IRX<0)		&&	(.IRY>0)
#define BUTTON_DIGITAL_UP					0x00040000l	// 方向キー上				dijs.rgdwPOV[0] == 0
#define BUTTON_DIGITAL_RIGHTUP				0x00080000l	// 方向キー右上				dijs.rgdwPOV[0] == 4500
#define BUTTON_DIGITAL_RIGHT				0x00100000l	// 方向キー右				dijs.rgdwPOV[0] == 9000
#define BUTTON_DIGITAL_RIGHTDOWN			0x00200000l	// 方向キー右下				dijs.rgdwPOV[0] == 13500
#define BUTTON_DIGITAL_DOWN					0x00400000l	// 方向キー下				dijs.rgdwPOV[0] == 18000
#define BUTTON_DIGITAL_LEFTDOWN				0x00800000l	// 方向キー左下				dijs.rgdwPOV[0] == 22500
#define BUTTON_DIGITAL_LEFT					0x01000000l	// 方向キー左				dijs.rgdwPOV[0] == 27000
#define BUTTON_DIGITAL_LEFTUP				0x02000000l	// 方向キー左上				dijs.rgdwPOV[0] == 31500
#define BUTTON_L2							0x04000000l	// L2						(.IZ>32767)
#define BUTTON_R2							0x08000000l	// R2						(.IZ<32767)
...
//---------------------------- game pad
BOOL IsButtonPressedDigital(int padNo, DWORD button);
BOOL IsButtonPressedAnalog(int padNo, DWORD button);
DIJOYSTATE2 *IsButtonPressedAnalog(void);
