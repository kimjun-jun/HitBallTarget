...
#define WINDOW_NAME			_T("キムジュンデンセツ3")	// ウインドウのキャプション名
...
//{
//	if (type == 0) g_gameset = true;
//	else if (type == 1)g_gameset = false;
//	else;
//}
//
////=============================================================================
...
//{
//	if (type == GAME_OD_NEXT) g_gameODloop = true;
//	else if (type == GAME_OD_STOP)g_gameODloop = false;
//	else;
//}
//
////=============================================================================
